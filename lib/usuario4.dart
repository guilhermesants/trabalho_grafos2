...
class Usu4 extends StatefulWidget {
  @override
  _Usu4State createState() => _Usu4State();
}

class _Usu4State extends State<Usu4> {
  List<String> listaFilmeCompartilhado4= [];
  ...
  void acaoRecomendado(index, texto){
    void inserir (cont, total){
      setState(() {
          ...
          if (listaFilmeCompartilhado4.contains(listaFilmeCompartilhadoTeste[0])){
            listaFilmeCompartilhadoTeste.clear();
          }else{
            listaFilmeCompartilhado4.add(listaFilmeCompartilhadoTeste[0]);
            listaFilmeCompartilhadoTeste.clear();
          }
          print(listaFilmeCompartilhado4);*/
        });
    }
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: variavelStaticas.qttFilmes4,
                itemBuilder: (context, index){
                  return Card(
                    color: Colors.white,
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            title: Text("${variavelStaticas.user4[index]}",
                            style: TextStyle(
                              fontSize: 15
                            ),
                            ),
                            subtitle: Text("${variavelStaticas.user4Cate[index]}",
                            style: TextStyle(
                              fontSize: 10
                            ),
                            ),
