...
class Usu5 extends StatefulWidget {
  @override
  _Usu5State createState() => _Usu5State();
}

class _Usu5State extends State<Usu5> {
  List<String> listaFilmeCompartilhado5= [];
  List<String> listaFilmeCompartilhadoReceptador;
  var listaFilmeCompartilhadoTeste= [];
  int numm = 0;
  int qtdfilmes = 200;
  ...
  void acaoRecomendado(index, texto){
    void inserir (cont, total){
      setState(() {
          ...
          variavelStaticas.user2 = dataNomesFilmesRec;
          ...
          variavelStaticas.user2Cate = dataCategoriasFilmesRec;
          ...
          variavelStaticas.qttFilmes2 = 50;
          ...
          if (listaFilmeCompartilhado5.contains(listaFilmeCompartilhadoTeste[0])){
            listaFilmeCompartilhadoTeste.clear();
          }else{
            listaFilmeCompartilhado5.add(listaFilmeCompartilhadoTeste[0]);
            listaFilmeCompartilhadoTeste.clear();
          }
          print(listaFilmeCompartilhado5);
        });
    }
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: variavelStaticas.qttFilmes5,
                itemBuilder: (context, index){
                  return Card(
                    color: Colors.white,
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            title: Text("${variavelStaticas.user5[index]}",
                            style: TextStyle(
                              fontSize: 15
                            ),
                            ),
                            subtitle: Text("${variavelStaticas.user5Cate[index]}",
                            style: TextStyle(
                              fontSize: 10
                            ),
                            ),
