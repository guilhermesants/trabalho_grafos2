...
class Usu1 extends StatefulWidget {
  
  @override
  _Usu1State createState() => _Usu1State();
}

class _Usu1State extends State<Usu1> {
  List<String> listaFilmeCompartilhado1= [];
  ...
  void acaoRecomendado(index, texto){
    void inserir (cont, total){
      setState(() {
          ...
          if (listaFilmeCompartilhado1.contains(listaFilmeCompartilhadoTeste[0])){
            listaFilmeCompartilhadoTeste.clear();
          }else{
            listaFilmeCompartilhado1.add(listaFilmeCompartilhadoTeste[0]);
            
            listaFilmeCompartilhadoTeste.clear();
          }
          ///print(listaFilmeCompartilhado1);
          ///variavelStaticas.qttFilmes = 10;
          print(variavelStaticas.user2);
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: variavelStaticas.qttFilmes1,
                itemBuilder: (context, index){
                  return Card(
                    color: Colors.white,
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            title: Text("${variavelStaticas.user1[index]}",
                            style: TextStyle(
                              fontSize: 15
                            ),
                            ),
                            subtitle: Text("${variavelStaticas.user1Cate[index]}",
                            style: TextStyle(
                              fontSize: 10
                            ),
                            ),
