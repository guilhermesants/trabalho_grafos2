...
class Usu3 extends StatefulWidget {
  @override
  _Usu3State createState() => _Usu3State();
}

class _Usu3State extends State<Usu3> {
  List<String> listaFilmeCompartilhado3= [];
  ...
  void acaoRecomendado(index, texto){
    void inserir (cont, total){
      setState(() {
          ...
          if (listaFilmeCompartilhado3.contains(listaFilmeCompartilhadoTeste[0])){
            listaFilmeCompartilhadoTeste.clear();
          }else{
            listaFilmeCompartilhado3.add(listaFilmeCompartilhadoTeste[0]);
            listaFilmeCompartilhadoTeste.clear();
          }
          print(listaFilmeCompartilhado3);*/
        });
    }
        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: variavelStaticas.qttFilmes3,
                itemBuilder: (context, index){
                  return Card(
                    color: Colors.white,
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            title: Text("${variavelStaticas.user3[index]}",
                            style: TextStyle(
                              fontSize: 15
                            ),
                            ),
                            subtitle: Text("${variavelStaticas.user3Cate[index]}",
                            style: TextStyle(
                              fontSize: 10
                            ),
                            ),
